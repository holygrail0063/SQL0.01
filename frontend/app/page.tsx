...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-ink text-slate-950" id="main-content">
      <AuthHashRedirect />
      <PublicHeader />
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-5 pb-20 pt-16 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        <div>
          ...
          <h1 className="max-w-3xl text-5xl font-semibold leading-tight text-slate-950 md:text-6xl">Practice SQL like it&apos;s your job.</h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a className="inline-flex items-center gap-2 rounded-full border border-line px-5 py-3 text-sm font-semibold text-slate-700 hover:border-brand-strong/50" href="#product">
              See How It Works
            </a>
          </div>
        ...
        <div className="rounded-lg border border-line bg-panel shadow-2xl shadow-slate-900/10">
          <div className="flex items-center justify-between border-b border-line px-4 py-3">
            <div>
              <p className="text-sm font-semibold text-slate-950">SQLBank / Loan Analytics</p>
          ...
          <div className="grid min-h-[410px] grid-cols-1 md:grid-cols-[1fr_220px]">
            <div className="border-r border-line">
              <div className="border-b border-line p-4">
                <h2 className="text-lg font-semibold text-slate-950">Find the five branches with the highest loan approval rate.</h2>
                <p className="mt-2 text-sm text-slate-600">Intermediate • Business Analysis</p>
              </div>
              <pre className="min-h-[250px] overflow-hidden p-5 font-mono text-sm leading-7 text-slate-700">
            ...
            <aside className="p-4 font-mono text-xs text-slate-600">
      ...
      <section className="border-y border-line bg-panel/60" id="product">
        <div className="mx-auto max-w-7xl px-5 py-20">
          <h2 className="text-3xl font-semibold text-slate-950">Learn SQL by doing SQL.</h2>
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {[
              ...
              <div className="rounded-lg border border-line bg-panel p-6" key={String(title)}>
                ...
                <h3 className="mt-5 text-lg font-semibold text-slate-950">{String(title)}</h3>
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-5 py-20 lg:grid-cols-[0.85fr_1fr]" id="about">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-semibold text-slate-950">Welcome to SQLBank</h2>
        ...
        <div className="rounded-lg border border-line bg-panel p-5 font-mono text-sm text-slate-700">
          <p className="mb-4 text-cyan">SQLBankTraining</p>
      ...
      <section className="border-y border-line bg-panel/60" id="paths">
        <div className="mx-auto max-w-7xl px-5 py-20">
          <h2 className="text-3xl font-semibold text-slate-950">SQL for where you&apos;re going.</h2>
      ...
      <section className="mx-auto max-w-4xl px-5 py-20 text-center">
        ...
        <h2 className="mt-5 text-4xl font-semibold text-slate-950">Stop watching SQL. Start writing it.</h2>
        <p className="mt-4 text-slate-700">Your first SQL challenge is ready.</p>
