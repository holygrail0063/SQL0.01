...
export function ChallengeNavigation({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        className="inline-flex h-9 items-center gap-1 rounded bg-brand px-3 text-sm font-semibold text-white disabled:cursor-not-allowed disabled:bg-slate-700 disabled:text-slate-400"
